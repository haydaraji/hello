package com.halo.hello.constant;
...
public class SpringDataJPAMultitenantConstants {
    ...
    public static final String TENANT_PATH= ROOT_PATH + "api/" + TENANT ;
    public static final String TENANTID_PATH = TENANT_PATH + SLASH + "{" + TENANT_ID + "}";
    public static final String TENANT_MASTER = TENANTID_PATH + "/master";
    ...
    public static boolean wasLoadTenant;
}
